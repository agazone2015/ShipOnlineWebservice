...
*
* This page is MAIN PAGE FOR THE SHIP ONLINE SERVICE
****************************************************-->
...
<head>
    ...
    <title>Ship Online Home Page</title>
...
<body>
	...
	<div class="wrapper">
	    ...
	    <!-- Header -->
	    <header>
		<img src="images/banner1.jpg" alt="header pic" id="banner"/>
                <h1>Ship Online System Home Page</1>
	    </header>
	    <!-- /Header -->
	    <!-- Master Nav -->
        </div>
            ...
            <section>
                ...
                <article class="main">
                    <ul id="menu">
                        ...
                        <p>Administrators: &#160;&#160;&#160;&#160;&#160;<a href="admin.php">Administration</a></p>
                    </ul>
                </article>
                <!-- /Article -->
            </section>
